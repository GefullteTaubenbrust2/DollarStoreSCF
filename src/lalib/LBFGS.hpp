...
namespace flo {
	...
	// [3] D. Goldfarb, A family of variable-metric methods derived by variational means, Mathematics of Computation, Volume 24, Issue 109, 1970, Pages 23-26.
	// [4] D. F. Shanno, Optimal Conditioning of Quasi-Newton Methods, Mathematics of Computation, Volume 24, Issue 111, 1970, Pages 657-657.
	struct LBFGSSolver {
	private:
		uint iterations = 8;
